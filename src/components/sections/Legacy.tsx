    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
        <Reveal className="flex flex-col gap-4 items-start">
          ...
          <h2 className="max-w-4xl text-4xl font-display uppercase tracking-tightest leading-[0.95] sm:text-6xl lg:text-7xl text-navy-950">
          ...
          <div className="mt-2 inline-flex items-center gap-4 bg-navy-900 border border-navy-700/80 px-6 py-3.5 rounded-2xl shadow-xl w-fit">
            <UPLMark className="h-14 w-auto sm:h-16" />
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {leagueHighlights.map((item, i) => (
            ...
            >
              ...
              <h3 className="mt-2 text-xl font-display uppercase tracking-tight text-ice-200">{item.value}</h3>
        ...
        <div className="mt-20">
          <Reveal>
            <h3 className="mb-10 text-center text-3xl font-display uppercase tracking-tightest text-navy-950">
