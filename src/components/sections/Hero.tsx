    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pt-28 pb-16 text-center bg-navy-900">
      ...
      <div className="relative z-10 flex flex-col items-center gap-7">
        ...
        >
          ...
          <UPLMark className="h-14 w-auto sm:h-20 transition-transform duration-300 hover:scale-105" priority />
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl lg:text-7xl font-display font-extrabold uppercase tracking-[0.08em] text-white drop-shadow-md"
        >
          Tehri Titans
        </motion.h1>
