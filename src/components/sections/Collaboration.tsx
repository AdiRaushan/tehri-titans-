        ...
        <Reveal className="mt-12 flex items-center justify-center gap-6 sm:gap-10 bg-navy-900 py-6 px-8 rounded-2xl border border-navy-700 max-w-lg mx-auto shadow-xl">
          ...
          {academyLogo ? (
            <Image
              ...
              width={220}
              height={220}
              className="h-24 w-24 object-contain sm:h-28 sm:w-28 transition-transform duration-300 hover:scale-105"
            />
          ) : (
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal className="lg:pt-2">
            <GlassCard className="p-6 sm:p-8" theme="light">
              <h3 className="text-xl font-display uppercase tracking-tight text-navy-950">What the partnership brings</h3>
